  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
        <p className="text-sm font-medium text-gray-900 mb-0.5">파일 선택</p>
        <p className="text-xs text-gray-400 mb-3">
          MP3 · WAV · M4A · FLAC · OGG &nbsp;|&nbsp; MP4 · WebM &nbsp;·&nbsp; 60초 초과 시 앞 60초만 처리
        </p>

        {/* Styled drop-zone wrapping the hidden input */}
        <label className="flex flex-col items-center gap-2 w-full cursor-pointer rounded-xl border-2 border-dashed border-gray-200 bg-gray-50 py-7 px-4 text-center transition-colors hover:border-blue-300 hover:bg-blue-50/40">
          <svg
      ...
      <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
        <p className="text-sm font-medium text-gray-900 mb-0.5">목표 언어</p>
        <p className="text-xs text-gray-400 mb-3">
      ...
      <div className="flex flex-col gap-2">
        <button
          ...
          className="w-full rounded-xl bg-blue-600 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-700 active:bg-blue-800 disabled:cursor-not-allowed disabled:opacity-40"
        >
      ...
      {status === "loading" && (
        <div className="rounded-2xl border border-blue-100 bg-blue-50 px-5 py-4">
          <div className="flex items-center gap-2.5 mb-2">
            <span className="inline-block h-3.5 w-3.5 shrink-0 animate-spin rounded-full border-2 border-blue-200 border-t-blue-600" />
      ...
      {status === "error" && error && (
        <div className="rounded-2xl border border-red-200 bg-red-50 px-5 py-4">
          <p className="mb-1 text-sm font-medium text-red-700">오류가 발생했습니다</p>
      ...
      {status === "done" && result && (
        <div className="flex flex-col gap-3 pt-1">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-xs font-medium text-green-600">더빙 완료</span>
          </div>
